...
//   ws.send("Hello Client! Successful connection established 😄");
// });
...
app.post("/register-player1/player1", (req, res) => {
  console.log("GOT THE PLAYER! DETAILS");
  handleRequest(req, res);
}); // only this function does ask for the password for the register player

app.get("/register-player/player2", (req, res) => {
  handleRequest(req, res);
}); // only this function does ask for the password for the register player
